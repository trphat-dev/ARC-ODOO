...
class CityWidget extends Component {
    ...
    <div class="fund-management-widget slide-in-bottom">
        ...
        <div class="page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h1 class="h3 mb-1">Danh mục Thành phố (Tỉnh)</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fas fa-home me-1"></i>Trang chủ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Danh mục Thành phố (Tỉnh)</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="position-relative">
                            ...
                            <input type="text" 
                                placeholder="Tìm theo tên hoặc mã thành phố..."
                    ...
                    <table class="table table-fmc table-hover align-middle">
                        ...
                        <tbody>
                                    ...
                                    <td colspan="5" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                             <div class="bg-light rounded-circle p-4 mb-3">
                                                 <i class="fas fa-city fa-3x text-secondary opacity-50"></i>
                                            </div>
                                            <h5 class="text-dark fw-bold">Chưa có dữ liệu</h5>
                                            <p class="text-muted mb-3">Không tìm thấy thành phố nào.</p>
                            ...
                            <t t-foreach="state.cities" t-as="city" t-key="city.id">
                                <tr>
                                    <td>
                                        <div class="fw-bold text-dark" t-esc="city.name"/>
                                    </td>
                                    <td>
                                        <span class="badge bg-light text-dark border fw-bold" t-esc="city.code"/>
                                    </td>
                                    <td>
                                        <span class="text-muted" t-esc="city.country_name"/>
                                    </td>
                                    <td class="text-center">
                                        <span t-if="city.active" class="badge-fmc badge-success">Kích hoạt</span>
                                        <span t-else="" class="badge-fmc badge-danger">Không kích hoạt</span>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <button t-on-click.prevent="() => this.handleEdit(city.id)" class="btn btn-sm btn-light border" title="Chỉnh sửa">
                                                <i class="fas fa-edit text-primary"></i>
                                            </button>
                                            <button t-on-click.prevent="() => this.handleDelete(city.id)" class="btn btn-sm btn-light border" title="Xóa">
