...
class CountryWidget extends Component {
    ...
    <div class="fund-management-widget slide-in-bottom">
        ...
        <div class="page-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <h1 class="h3 mb-1">Danh mục Quốc gia</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="fas fa-home me-1"></i>Trang chủ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Danh mục Quốc gia</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <table class="table table-fmc table-hover align-middle">
                        ...
                        <tbody>
                                    ...
                                    <td colspan="5" class="text-center py-5">
                                        <div class="d-flex flex-column align-items-center">
                                             <div class="bg-light rounded-circle p-4 mb-3">
                                                 <i class="fas fa-globe fa-3x text-secondary opacity-50"></i>
                                            </div>
                                            <h5 class="text-dark fw-bold">Chưa có dữ liệu</h5>
                                            <p class="text-muted mb-3">Không tìm thấy quốc gia nào.</p>
                            ...
                            <t t-foreach="state.countries" t-as="country" t-key="country.id">
                                <tr>
                                    <td>
                                        <div class="fw-bold text-dark" t-esc="country.name"/>
                                    </td>
                                    <td>
                                        <span class="badge bg-light text-dark border fw-bold" t-esc="country.code"/>
                                    </td>
                                    <td>
                                        <span class="text-muted" t-esc="country.phone_code"/>
                                    </td>
                                    <td class="text-center">
                                        <span t-if="country.active" class="badge-fmc badge-success">Kích hoạt</span>
                                        <span t-else="" class="badge-fmc badge-danger">Không kích hoạt</span>
                                    </td>
                                    <td class="text-center">
                                         <div class="d-flex justify-content-center gap-2">
                                            <button t-on-click.prevent="() => this.handleEdit(country.id)" class="btn btn-sm btn-light border" title="Chỉnh sửa">
                                                <i class="fas fa-edit text-primary"></i>
                                            </button>
                                            <button t-on-click.prevent="() => this.handleDelete(country.id)" class="btn btn-sm btn-light border" title="Xóa">
